...
E-mail your findings to [security@pagopa.it](mailto:security@pagopa.it). Encrypt your findings using our [PGP key](/publickey.txt) to prevent this critical information from falling into the wrong hands.
