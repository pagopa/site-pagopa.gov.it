...
module Jekyll
    ...
    class DataPage < Page
      ...
      def initialize(site, base, index_files, dir, page_data_prefix, data, name, name_expr, title, title_expr, template, extension, paginatehook, child_of_ref, lang)
        @site = site
        @base = base
        ...
        self.data['child_of_ref'] = child_of_ref
        self.data['lang'] = lang
      ...
      def generate(site)
        ...
        if data
          data.each do |data_spec|
            ...
            child_of_ref     = data_spec['child_of_ref'] || ''
            lang             = data_spec['lang'] || ''
            ...
            if site.layouts.key? template
              ...
              records.each do |record|
                site.pages << DataPage.new(site, site.source, index_files_for_this_data, dir, page_data_prefix, record, name, name_expr, title, title_expr, template, extension, paginatehook, child_of_ref, lang)
              end
            else
